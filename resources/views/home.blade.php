...
<body>
    ...
    <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active c-item">
                <img src="../../public/tmpt1.jpg" class="d-block w-100 c-img" alt="slide1">
            </div>
            <div class="carousel-item c-item">
                <img src="../../public/tmpt2.jpg" class="d-block w-100 c-img" alt="slide2">
            </div>
            <div class="carousel-item c-item">
                <img src="../../public/tmpt3.jpg" class="d-block w-100 c-img" alt="slide3">
            </div>
        </div>
    ...
    <section id="foods" class="section-relative mt-5">
        <div class="bg-image">
            <img src="src/coffee2.jpg" alt="" class="w-100 c-img" style="filter: brightness(50%); ">
        </div>
        <div class="container">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 order-1 order-md-0 d-flex flex-column">
                        <div class="content-body">
                            <img src="src/coffee2.jpg" alt="" class="w-75 rounded">
                        </div>
                    </div>
            ...
            <div class="content px-md-5">
                <div class="row">
                    <div class="col-12 col-lg-6 content-body">
                        <img src="src/tmpt1.jpg" alt="" class="w-100 rounded">
                    </div>
